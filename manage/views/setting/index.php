<?php echo $info123;?>
<div class="kanwil">
	<h2>INFORMASI DATA : SETTING ADMINISTRATOR</h2>
	 
	<div class="showhide">
	<?php
	echo form_open_multipart('datapenilai/menambah_penilai_selain_djkn');
	echo "<table cellpadding=\"0\" cellspacing=\"0\">";
	echo "<tr><td width=\"200px\">ID Penilai</td><td>".form_input(array('id'=>'idpenilai','name'=>'idpenilai'),set_value('idpenilai')).  "</td></tr>";
	echo "<tr><td width=\"200px\">NIP Lama</td><td>".form_input('niplama',set_value('niplama')). form_error('niplama'). "</td></tr>";
	echo "<tr><td width=\"200px\">NIP Baru</td><td>".form_input('nipbaru',set_value('nipbaru')).  form_error('nipbaru')."</td></tr>";
	echo "<tr><td width=\"200px\">Nama Pegawai</td><td>".form_input('namapgw',set_value('namapgw')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Pangkat</td><td>".form_input('pangkat',set_value('pangkat')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Tempat Lahir</td><td>".form_input('tmplahir',set_value('tmplahir')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Tanggal Lahir</td><td>".form_input(array('id'=>'tgl1','name'=>'tanggallahir','class'=>'tgl'),set_value('tanggallahir')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Uraian Jabatan</td><td>".form_input('uraianjabatan',set_value('uraianjabatan')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Tamat Jabatan</td><td>".form_input(array('id'=>'tgl2','name'=>'tmtjabatan','class'=>'tgl'),set_value('tmtjabatan')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Jenjang Pendidikan</td><td>".form_input('jenjangpendidikan',set_value('jenjangpendidikan')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Jenis Kelamin</td><td>".form_input('jnskelamin',set_value('jnskelamin')).  "</td></tr>";
	echo "<tr><td width=\"200px\">No SK Penilai</td><td>".form_input('noskpenilai',set_value('noskpenilai')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Tgl SK Penilai</td><td>".form_input(array('id'=>'tgl3','name'=>'tglskpenilai','class'=>'tgl'),set_value('tglskpenilai')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Sekolah</td><td>".form_input('sekolah',set_value('sekolah')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Uraian Jurusan</td><td>".form_input('uraianjurusan',set_value('uraianjurusan')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Status Pegawai</td><td>".form_dropdown('statuspegawai',array('aktif' => 'Status Aktif','tidak' => 'Tidak Aktif'),set_value('statuspegawai')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Alamat Rumah</td><td>".form_input('alamatrumah',set_value('alamatrumah')).  "</td></tr>";
	echo "<tr><td width=\"200px\">No Telp/HP</td><td>".form_input('telphp',set_value('telphp')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Alamat Email</td><td>".form_input('email',set_value('email')).  "</td></tr>";
	echo "<tr><td width=\"200px\">Keterangan Lain-Lain</td><td>".form_input('ketlainlain',set_value('ketlainlain')).  "</td></tr>";
	echo "</table>";

	echo "<p class='notifform'>". form_submit('submit_form', 'Save As')."  <span class='actions'>".anchor('/datapenilai/menambah_penilai_selain_djkn','Kembali')."</span>  Pastikan isian telah terisi keseluruhan dan benar! </p>";
	echo form_close();
	?>
	</div>
...
<div id="tablewrapper">
		<div id="tableheader">
        	<span class="detai"> 
				<div class='actions'><a href='#' id='2' onclick="$('.showhide').show('slow')">Tambah Data</a></div> 
				<div class='actions'><a href='#' id='2' onclick="$('.showhide').hide('slow')">Hide Form</a></div>
			</span>
			<span class="detail">
			...
			<span class="detailss">
				<div class='actions'><a href="javascript:sorter.reset()">Reset Filter</a></div>
        		<div class='actions'><a href="javascript:self.history.back()">Back</a></div>
        	</span>
            <span class="details">
				<div>Jumlah baris data <span id="startrecord"></span>-<span id="endrecord"></span> dari <span id="totalrecords"></span></div>
        	</span>
        </div>
        ...
        <div id="tablefooter">
          <div id="tablenav">
                ...
                <div>
                	<a href="javascript:sorter.showall()">Lihat Semua Data</a>
                </div>
            </div>
			<div id="tablelocation">
                ...
                <div class="page">Data per halaman</div> <div class="page">|</div><div class="page">  Halaman <span id="currentpage"></span> dari <span id="totalpages"></span></div>
            </div>
        </div>
    </div>
